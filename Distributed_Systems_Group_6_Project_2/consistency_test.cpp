...
int main(int argc, char **argv) {
  ...
  std::vector<events> sortedBigTable(num_of_threads * num_of_runs);
  ...
  //std::cout << sortedBigTable.size() << std::endl;
    ...
    int i = 0;
    while (i < ((num_of_runs * num_of_threads) - 19)) { // YOU MAY OCCUR SEGMENTATION FAULT; do not process unknown memory.
