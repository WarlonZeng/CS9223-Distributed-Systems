...
// std::map<std::string, std::mutex*> Lock_Manager;
...
int main(int argc, char **argv) {
  ...
  // these are hardcoded, bu tis possible to dynamically create locks. 
  // std::mutex lck1;
  // std::mutex lck2;
  // std::mutex* ptrToLck1;
  // std::mutex* ptrToLck2;

  // Lock_Manager.emplace("abc", new std::mutex);
  // Lock_Manager.emplace("xyz", new std::mutex);

  // Lock_Manager["abc"] = ptrToLck1;
  // Lock_Manager["xyz"] = ptrToLck2;
